...
def add_new_zip_plugin(plugins_tree: ElementTree, zip_fileobject: IO, zip_name: Path, plugin_file_name: str) -> None:
...
def add_new_jar_plugin(
    ...
    new_plugin_xml = _generate_plugin_xml_from_metadata(plugin_metadata, plugin_file_name)
